-- ========================================================================
-- COMPLETE DATABASE SCHEMA FOR CAREER ADVISOR PLATFORM
-- ========================================================================
-- This script creates all essential database tables with proper schema,
-- relationships, and RLS policies to eliminate the need for mock data.
...
-- Stores AI-generated career roadmaps with proper structure
...
-- Stores quiz results, answers, and AI recommendations
...
-- 4. COLLEGES TABLE
-- Master table of all colleges with comprehensive information
...
-- 5. SAVED_COLLEGES TABLE
-- User's saved colleges for later reference
...
-- For AI Job Hunter feature - stores job applications and resume analysis
...
-- 7. ACTIVITIES TABLE
-- Tracks all user activities for dashboard and analytics
...
INSERT INTO public.colleges (name, location, state, city, type, established, website, courses, rating, fees, cutoff, latitude, longitude, ranking) VALUES
('Indian Institute of Technology Delhi', 'Hauz Khas, New Delhi', 'Delhi', 'New Delhi', 'Government', 1961, 'https://home.iitd.ac.in', ARRAY['Computer Science', 'Mechanical Engineering', 'Electrical Engineering', 'Civil Engineering', 'Chemical Engineering'], 4.8, 250000, 'JEE Rank 1-500', 28.5449, 77.1928, 2),
('Birla Institute of Technology and Science', 'Pilani, Rajasthan', 'Rajasthan', 'Pilani', 'Private', 1964, 'https://www.bits-pilani.ac.in', ARRAY['Computer Science', 'Electronics', 'Mechanical', 'Chemical', 'Biotechnology'], 4.6, 450000, 'BITSAT 350+', 28.3670, 75.5886, 25),
('Delhi Technological University', 'Shahbad Daulatpur, Delhi', 'Delhi', 'New Delhi', 'Government', 1941, 'http://www.dtu.ac.in', ARRAY['Computer Engineering', 'Information Technology', 'Electronics', 'Mechanical', 'Civil'], 4.4, 175000, 'JEE Rank 3000-8000', 28.7501, 77.1177, 45),
('Manipal Institute of Technology', 'Manipal, Karnataka', 'Karnataka', 'Manipal', 'Private', 1957, 'https://manipal.edu', ARRAY['Computer Science', 'Information Technology', 'Mechanical', 'Aeronautical', 'Biomedical'], 4.3, 400000, 'MET Rank 1-5000', 13.3475, 74.7869, 55),
('Vellore Institute of Technology', 'Vellore, Tamil Nadu', 'Tamil Nadu', 'Vellore', 'Private', 1984, 'https://vit.ac.in', ARRAY['Computer Science', 'Electronics', 'Biotechnology', 'Chemical', 'Mechanical'], 4.2, 275000, 'VITEEE Rank 1-10000', 12.9716, 79.1588, 38),
('National Institute of Technology Trichy', 'Tiruchirappalli, Tamil Nadu', 'Tamil Nadu', 'Tiruchirappalli', 'Government', 1964, 'https://www.nitt.edu', ARRAY['Computer Science', 'Electronics', 'Mechanical', 'Civil', 'Chemical'], 4.7, 175000, 'JEE Rank 800-3000', 10.7596, 78.8149, 8);
...
BEGIN
    ...
    RAISE NOTICE '========================================================================';
    RAISE NOTICE 'All required tables have been created with:';
    RAISE NOTICE '✅ Proper schema and relationships';
    RAISE NOTICE '✅ Row Level Security (RLS) policies enforced';
    RAISE NOTICE '✅ Performance indexes added';
    RAISE NOTICE '✅ Auto-updating timestamps';
    RAISE NOTICE '✅ Sample college data inserted';
    RAISE NOTICE '✅ User registration triggers enabled';
    RAISE NOTICE '========================================================================';
    RAISE NOTICE 'Your application is now ready to use real database data!';
    RAISE NOTICE 'No more mock data fallbacks needed.';
    RAISE NOTICE '========================================================================';
END
$$;